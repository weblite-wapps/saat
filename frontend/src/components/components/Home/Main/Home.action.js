...
export const dispatchChangeTextSlider = (...args) =>
  dispatch(changeTextSlider(...args))

export const LOAD_TOTAL_DURATIONS = 'LOAD_TOTAL_DURATIONS'
export const loadTotalDurations = createAction(
  LOAD_TOTAL_DURATIONS,
  totalDurations => ({ totalDurations }),
)
export const dispatchLoadTotalDurations = (...args) =>
  dispatch(loadTotalDurations(...args))
...
export const dispatchRefetchTotalDuration = (...args) =>
  dispatch(refetchTotalDuration(...args))

export const COUNTINUE_COUNTING = 'COUNTINUE_COUNTING'
export const countinueCounting = createAction(COUNTINUE_COUNTING, _id => ({
  _id,
}))
export const dispatchCountinueCounting = (...args) =>
  dispatch(countinueCounting(...args))

export const SET_SECONDS_ELAPSED = 'SET_SECONDS_ELAPSED'
export const setSecondsElapsed = createAction(SET_SECONDS_ELAPSED, value => ({
  value,
}))
export const dispatchSetSecondsElapsed = (...args) =>
  dispatch(setSecondsElapsed(...args))
...
export const dispatchChangeRunningId = (...args) =>
  dispatch(changeRunningId(...args))

export const CHECK_TO_SET_SECONDS_ELAPSED = 'CHECK_TO_SET_SECONDS_ELAPSED'
export const checkToSetSecondsElapsed = createAction(
