...
export const getTimes = (logs, _id) =>
  R.view(timesLens, R.find(R.propEq('_id', _id))(logs))

const startLens = R.lensProp('start')
export const getStartTime = times =>
  R.view(startLens, times[R.length(times) - 1])
...
export const NextName = (currentStage, direction) => {
  switch (currentStage) {
    case 'Today':
      return 'This Week'
    case 'This Week':
      return direction === 'Next' ? 'This Month' : 'Today'
    case 'This Month':
      return 'This Week'
    default:
      return 'Today'
...
export const NextDuration = (currentStage, direction) => {
  switch (currentStage) {
    case 'Today':
      return 'thisWeek'
    case 'This Week':
      return direction === 'Next' ? 'thisMonth' : 'today'
    case 'This Month':
      return 'thisWeek'
    default:
      return 'today'
